  ...
  return (
    <React.Fragment>
      <div className="chepTwoMobcardHolder">
        <Container
          style={{ marginLeft: 36, paddingLeft: 0, marginRight: 0, width: 354 }}
        >
          {/* --------------------------------cardOne-------------------------------- */}
                  ...
                  <Col>
                    ...
                    <Row style={{ width: 211 }}>
                      ...
                      >
                        ...
                        He was prolific goal scorer in La Liga, with 28 goals in
                        34 matches. The quality and profile of Kempes led coach
                        Menotti to abandon his policy of selecting only
                  ...
                  <Col>
                    ...
                    <Row style={{ width: 211 }}>
                      ...
                      >
                        ...
                        Cup. He was president of the River Plate sports club for
                        four years after winning the elections by a very close
                        margin in December 2009.
                      </p>
                    </Row>
      ...
      <div className="chepTwoCardTHree">
        ...
        <div className="chepTwoCardThreeDesc">
          <p>
            In the first group stage (Group A), Argentina was placed with Italy,
            France and Hungary.
          </p>
          <p>
            La Albiceleste, the host nation, got off to a sluggish start with a
            close 2–1 victory over Hungary in their opening game. Argentines had
            a more attacking (2–1) victory over the French, but with a dubious
            awarded penalty for hand ball. They were up against the solid
            Italian team and lost that game convincingly 1–0 to the Azurri.
          </p>
          <p>
            Italy won the group comprehensively. Argentina, with the tension in
            the country, came in a lackluster second. Both teams automatically
        ...
        >
          ...
          <Row style={{ marginTop: 5, width: 254 }}>
            ...
            >
              La Albiceleste is the nickname of the Argentina national team. It
              refers to the colors of the team’s home jersey, the White and Sky
              Blues.
            </p>
          </Row>
          ...
          <div className="chepTwoLastCardText">
            ...
            <div className="lastCardSecond">
              <p style={{ marginBottom: 15 }}>
                ...
                to ensure viewing audiences weren’t baffled by getting France to
                wear white and Hungary to wear red. <br />
              </p>
              <p style={{ marginBottom: 15 }}>
