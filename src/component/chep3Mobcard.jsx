              ...
              >
                ...
                >
                  <p className="chepThreeCardOneDescText">
                    ...
                    the winner of the group would go on to the World Cup Final.
                    Argentina staggered into the group and their main rival was
                    Brazil, with Peru and Poland being the other teams.{" "}
                  </p>{" "}
                  <p
                    className="chepThreeCardOneDescText"
                    style={{ marginTop: 10 }}
                  >
                    The two teams had already played out a goalless draw. Was it
                    just a happy accident that the hosts knew exactly what they
                    needed to do following Brazil’s 3–1 win against Poland? With
                    a 4–0 win against Peru, they were in the final.
                  </p>
                </Row>
                  ...
                  <Col>
                    ...
                    <Row style={{ width: 211 }}>
                      ...
                      >
                        ...
                        South American giants had few opportunities on goal but
                        had plenty of fouls and yellow (five) cards. Both teams
                        knew that whoever would win the game would go to the
                        finals. That would be decided by their next games.
                      </p>
                    </Row>
          ...
          <div className="chepThreeLastCardText" style={{ width: "auto" }}>
            ...
            <div className="chep3lastCardSecond">
              <p style={{ marginBottom: 15 }}>
                The Argentines meet the Dutch, runners up of the 1974 World Cup.
                Rumors had already swirled about the legitimacy of the Argentine
                qualification game with Peru.
                <br />
              </p>
              <p style={{ marginBottom: 15 }}>
