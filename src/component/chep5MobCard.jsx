                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      delay the match, which allowed tension to build in front
                      of a hostile Buenos Aires crowd.
                    </p>
                    <p
                      className="chepFiveCardOneDescText"
                      style={{ marginTop: 10 }}
          ...
          <div className="chepFiveCardFourDesc">
            ...
            <div className="row" style={{ marginTop: 5, width: 260 }}>
              ...
              <p className="chepFiveCardFourDescimgDesc">
                ...
                the fallen in the South Atlantic conflict, on the thirty-sixth
            ...
            <div className="chepFiveDescCardFour">
              ...
              <p>
                ...
                Argentina, but that support disappeared after the military
                defeat. It was the beginning of the end for the Junta.
              </p>
              <div
                className="row"
                style={{
          ...
          <div className="chepFiveCardFiveDesc">
            ...
            <div className="row" style={{ marginTop: 5, width: 242 }}>
              ...
              <p className="chepFiveCardFiveDescimgDesc">
                ...
                natural causes in his sleep while serving his sentence at Marcos
                Paz prison.
              </p>
            </div>
          ...
          <div className="chepFiveLastCardDesc">
            ...
            <div className="chepFiveLastCardText" style={{ width: "auto" }}>
              ...
              <p className="chepFivelastCardFirst">
                ...
                presidential palace in the center of Buenos Aires, and protested
                in silence with other mothers of the disappeared.
              </p>
              <div
                className="row"
                style={{
